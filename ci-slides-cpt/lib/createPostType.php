...
function ciSliderTypeUpdatedMessages( $messages ) {
    ...
    $messages[CI_SLIDE_TYPE] = array(
        ...
        4 => __('Slide updated.', 'conversion-insights-shared'),
        /* translators: %s: date and time of the revision */
        5 => isset($_GET['revision']) ? sprintf( __('Slide restored to revision from %s', 'conversion-insights-shared'), wp_post_revision_title( (int) $_GET['revision'], false ) ) : false,
        6 => sprintf( __('Slide published. <a href="%s">View slide</a>'), esc_url( get_permalink($post_ID) ) ),
        7 => __('Slide saved.', 'conversion-insights-shared'),
