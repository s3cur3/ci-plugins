...
if( !function_exists('ciStaffTypeUpdatedMessages') ) {
    function ciStaffTypeUpdatedMessages( $messages ) {
        ...
        $messages[CI_STAFF_TYPE] = array(
            ...
            2 => __('Custom field updated.', 'conversion-insights-shared'),
            3 => __('Custom field deleted.', 'conversion-insights-shared'),
            4 => __('Staff member updated.', 'conversion-insights-shared'),
            /* translators: %s: date and time of the revision */
            5 => isset($_GET['revision']) ? sprintf( __('Staff member restored to revision from %s', 'conversion-insights-shared'), wp_post_revision_title( (int) $_GET['revision'], false ) ) : false,
            6 => sprintf( __('Staff member published. <a href="%s">View staff member</a>'), esc_url( get_permalink($post_ID) ) ),
            7 => __('Staff member saved.', 'conversion-insights-shared'),
